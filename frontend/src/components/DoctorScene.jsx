...
export default function DoctorScene({ speaking = false }) {
  return (
    <div className="w-full flex flex-col items-center">
      <div className={`relative select-none ${speaking ? "speaking" : ""}`}>
        <style>{`
        ...
        >
          <svg width="220" height="260" viewBox="0 0 220 260" fill="none">
            <ellipse className="shadow-e" cx="110" cy="248" rx="52" ry="8" fill="#888" />
            <g className="body-group">
              <g className="coat-l"><path d="M68 148 Q58 165 56 200 Q56 215 65 220 L78 220 L80 165 Z" fill="#f0f4ff" stroke="#c5cef7" strokeWidth="0.8"/></g>
              <g className="coat-r"><path d="M152 148 Q162 165 164 200 Q164 215 155 220 L142 220 L140 165 Z" fill="#f0f4ff" stroke="#c5cef7" strokeWidth="0.8"/></g>
              <rect x="76" y="142" width="68" height="82" rx="8" fill="#f8f9ff" stroke="#c5cef7" strokeWidth="0.8"/>
              <g className="stetho-g">
                <path d="M88 158 Q82 178 88 188 Q94 198 100 192" stroke="#7F77DD" strokeWidth="2.2" fill="none" strokeLinecap="round"/>
                <circle cx="100" cy="191" r="4.5" fill="none" stroke="#7F77DD" strokeWidth="2"/>
                <circle cx="100" cy="191" r="2" fill="#7F77DD"/>
                <circle cx="88" cy="158" r="3" fill="#7F77DD"/>
                <circle cx="84" cy="155" r="2" fill="#534AB7"/>
              </g>
              <g className="clip-g">
                <rect x="135" y="168" width="22" height="28" rx="3" fill="white" stroke="#c5cef7" strokeWidth="0.8"/>
                <rect x="139" y="165" width="14" height="5" rx="2.5" fill="#c5cef7"/>
                <line x1="138" y1="176" x2="154" y2="176" stroke="#c5cef7" strokeWidth="1"/>
                <line x1="138" y1="181" x2="154" y2="181" stroke="#c5cef7" strokeWidth="1"/>
                <line x1="138" y1="186" x2="148" y2="186" stroke="#c5cef7" strokeWidth="1"/>
              </g>
              <g className="arm-l">
                <path d="M76 155 Q62 168 60 190" stroke="#e8eeff" strokeWidth="14" strokeLinecap="round" fill="none"/>
                <path d="M76 155 Q62 168 60 190" stroke="#c5cef7" strokeWidth="0.8" strokeLinecap="round" fill="none"/>
                <ellipse cx="60" cy="193" rx="7" ry="5" fill="#fde5d7" stroke="#f0c4ae" strokeWidth="0.8"/>
              </g>
              <g className="arm-r">
                <path d="M144 155 Q158 168 160 190" stroke="#e8eeff" strokeWidth="14" strokeLinecap="round" fill="none"/>
                <path d="M144 155 Q158 168 160 190" stroke="#c5cef7" strokeWidth="0.8" strokeLinecap="round" fill="none"/>
                <ellipse cx="160" cy="193" rx="7" ry="5" fill="#fde5d7" stroke="#f0c4ae" strokeWidth="0.8"/>
              </g>
              <rect x="90" y="155" width="40" height="18" rx="5" fill="white" stroke="#c5cef7" strokeWidth="0.8"/>
              <text x="110" y="168" textAnchor="middle" fontSize="8" fill="#7F77DD" fontFamily="sans-serif" fontWeight="600">ADVISORY</text>
              <g className="head-g">
                <ellipse cx="110" cy="62" rx="38" ry="42" fill="#fde5d7" stroke="#f0c4ae" strokeWidth="0.8"/>
                ...
                <g className="blink-g"><ellipse cx="98" cy="65" rx="7" ry="8" fill="white" stroke="#e8d5c5" strokeWidth="0.5"/><ellipse cx="98" cy="66" rx="5" ry="5.5" fill="#3d2b1f"/><ellipse cx="98" cy="66" rx="3" ry="3" fill="#1a0f0a"/><circle cx="100" cy="64" r="1.5" fill="white"/></g>
                <g className="blink-g"><ellipse cx="122" cy="65" rx="7" ry="8" fill="white" stroke="#e8d5c5" strokeWidth="0.5"/><ellipse cx="122" cy="66" rx="5" ry="5.5" fill="#3d2b1f"/><ellipse cx="122" cy="66" rx="3" ry="3" fill="#1a0f0a"/><circle cx="124" cy="64" r="1.5" fill="white"/></g>
                ...
                <path className="mouth-s" d="M102 88 Q110 95 118 88" stroke="#c47a5a" strokeWidth="1.8" fill="none" strokeLinecap="round"/>
                <path d="M80 58 Q72 65 74 78" stroke="#f0c4ae" strokeWidth="4" strokeLinecap="round" fill="none"/>
                <path d="M140 58 Q148 65 146 78" stroke="#f0c4ae" strokeWidth="4" strokeLinecap="round" fill="none"/>
                <rect x="96" y="102" width="28" height="36" rx="4" fill="#fde5d7" stroke="#f0c4ae" strokeWidth="0.5"/>
                <path d="M96 115 Q110 120 124 115" fill="#e8c9b4"/>
                <path d="M104 104 Q110 100 116 104" stroke="#3a2a6d" strokeWidth="2" fill="none"/>
              </g>
            </g>
            <circle className="pulse-r" cx="110" cy="110" r="70" fill="none" stroke="#7F77DD" strokeWidth="1.5"/>
          </svg>
        </motion.div>
      </div>
    </div>
