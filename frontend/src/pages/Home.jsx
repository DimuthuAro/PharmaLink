...
const GradientOrbs = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    <div className="absolute -top-40 -right-40 w-[700px] h-[700px] bg-gradient-to-br from-blue-400/20 via-indigo-500/15 to-purple-400/20 rounded-full blur-3xl animate-morph" style={{ animationDuration: '25s' }}></div>
    <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] bg-gradient-to-br from-cyan-400/15 via-teal-500/10 to-emerald-400/15 rounded-full blur-3xl animate-morph" style={{ animationDuration: '30s', animationDelay: '5s' }}></div>
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-violet-400/5 via-purple-500/5 to-pink-400/5 rounded-full blur-3xl animate-spin-slow"></div>
  </div>
);
    ...
    {[...Array(25)].map((_, i) => (
      <div
        ...
        style={{
          ...
          top: `${Math.random() * 100}%`,
          background: ['#3B82F6', '#8B5CF6', '#06B6D4', '#10B981', '#F59E0B', '#EC4899'][i % 6],
    ...
    {[...Array(8)].map((_, i) => (
      ...
      >
        <svg width="50" height="24" viewBox="0 0 50 24">
          <rect x="0" y="0" width="50" height="24" rx="12" fill={i % 2 === 0 ? '#3B82F6' : '#8B5CF6'} />
          <rect x="25" y="0" width="25" height="24" rx="12" fill={i % 2 === 0 ? '#60A5FA' : '#A78BFA'} />
        </svg>
      </div>
    ))}
  </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-slate-100 p-4 animate-fadeInUp">
              <nav className="flex flex-col gap-2">
                {['Features', 'About', 'Modules', 'Stats'].map((item) => (
                  <a
                    key={item}
      ...
      <main className="relative z-10">
        ...
        <section className="relative min-h-screen flex items-center pt-32 pb-20 px-4">
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              <div className="relative z-20 animate-slideInLeft" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 border border-emerald-200/50 px-3 py-1.5 text-xs font-semibold text-emerald-700">
                ...
                {/* Stats Row */}
                <div className="grid grid-cols-3 gap-6 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-slate-200/50 shadow-xl">
                  {[
                    ...
                    <div key={idx} className="text-center">
                      ...
                      <p className="text-2xl md:text-3xl font-black bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{stat.value}</p>
              ...
              <div className="relative animate-slideInRight" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="absolute -left-6 top-1/4 backdrop-blur-xl bg-white/90 border border-white/50 rounded-2xl p-4 shadow-2xl animate-bounce-subtle hidden lg:block">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Interactions Checked</p>
                    </div>
                  </div>
                </div>

                <div className="absolute -right-4 bottom-1/4 backdrop-blur-xl bg-white/90 border border-white/50 rounded-2xl p-4 shadow-2xl animate-bounce-subtle hidden lg:block" style={{ animationDelay: '0.5s' }}>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg">
                      <StarSolid className="h-5 w-5 text-white" />
                    </div>
                    <div>
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
            <a href="#features" className="flex flex-col items-center gap-2 text-slate-400 hover:text-blue-600 transition-colors">
        ...
        <section id="stats" className="relative py-24 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 px-4 py-2 text-xs font-bold uppercase tracking-wider text-white mb-4">
              ...
              <p className="text-lg text-blue-100 max-w-2xl mx-auto">
                Join thousands of clinicians and pharmacists who trust PharmaLink for medication safety.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {[
                { value: "50K+", label: "Interactions Checked", icon: ShieldCheckIcon, suffix: "" },
                { value: "99.2", label: "Accuracy Rate", icon: CheckCircleIcon, suffix: "%" },
                { value: "10K+", label: "Healthcare Professionals", icon: UserGroupIcon, suffix: "" },
                { value: "24/7", label: "System Availability", icon: ClockIcon, suffix: "" }
              ].map((stat, idx) => (
                <div
                  key={idx}
                  className="group relative overflow-hidden backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 hover:bg-white/20 transition-all duration-500 hover:-translate-y-2"
                >
                  {/* Icon */}
                  ...
                  {/* Decorative */}
                  <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-white/5 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-16 flex flex-wrap justify-center items-center gap-6 md:gap-10">
              {[
                ...
                { text: "FDA Database", icon: "💊" },
                { text: "DrugBank Integrated", icon: "🧬" },
                { text: "Peer Reviewed", icon: "📚" },
                { text: "Clinical Grade", icon: "⚕️" }
              ].map((badge, idx) => (
                <div key={idx} className="flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
        ...
        <section className="relative py-24 px-4">
          <div className="max-w-7xl mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16">
              <span className="inline-flex items-center gap-2 rounded-full bg-amber-50 border border-amber-200/50 px-4 py-2 text-xs font-bold uppercase tracking-wider text-amber-700 mb-4">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                See what clinicians, pharmacists, and patients say about PharmaLink.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  quote: "PharmaLink has transformed how we handle medication safety checks. The AI-powered interaction detection is incredibly accurate.",
                ...
                {
                  quote: "The prescription interpretation feature alone has saved us countless hours. It's like having an extra pair of expert eyes.",
                ...
                {
                  quote: "Finally a platform that considers nutrition alongside medications. My patients love the comprehensive approach to their health.",
                ...
                <div
                  key={idx}
                  className="group relative overflow-hidden backdrop-blur-xl bg-white/80 border border-slate-200/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                >
                  {/* Rating Stars */}
                  <div className="flex gap-1 mb-6">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <StarSolid key={i} className="h-5 w-5 text-amber-400" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-3xl">
                      {testimonial.avatar}
                    </div>
                    <div>
                  ...
                  <div className="absolute -top-4 -right-4 text-9xl font-serif text-slate-100 pointer-events-none select-none">
                    "
                  </div>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-r from-slate-50 via-white to-blue-50 border border-slate-200/70 shadow-2xl">
              ...
              <div className="relative grid gap-12 lg:grid-cols-2 items-center p-8 md:p-12 lg:p-16">
                ...
                <div className="relative">
                  {/* Glow Effect */}
                  <div className="absolute -inset-4 bg-gradient-to-br from-blue-500/20 via-indigo-500/20 to-purple-500/20 rounded-3xl blur-2xl"></div>

                  <div className="relative overflow-hidden rounded-3xl shadow-2xl border border-white/50 bg-slate-950">
                    {/* Gradient Top Bar */}
                  ...
                  {/* Floating Badge */}
                  <div className="absolute -bottom-4 -right-4 backdrop-blur-xl bg-white/90 border border-white/50 rounded-2xl p-4 shadow-2xl">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                        <PlayIcon className="h-5 w-5 text-white" />
                      </div>
                      <div>
                        <p className="text-sm font-bold text-slate-900">Watch Demo</p>
                        <p className="text-xs text-slate-500">2 min overview</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-12 md:p-16 text-center shadow-2xl">
              ...
              <div className="relative">
                ...
                <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-10">
                  Join thousands of healthcare professionals who trust PharmaLink for accurate, AI-powered drug interaction analysis.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div className="space-y-6">
                  ...
                  <ul className="space-y-3">
                    {[
                      { label: 'Drug Interaction Check', icon: '💊', path: '/interaction-check' },
                      { label: 'Nutrition Advisory', icon: '🥗', path: '/advisory' },
                      { label: 'Brand Comparator', icon: '⚖️', path: '/comparator' },
                      { label: 'Prescription AI', icon: '📋', path: '/prescription' }
                    ].map((link) => (
                      <li key={link.label}>
                        <button
